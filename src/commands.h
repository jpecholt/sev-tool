...
const std::string CALC_MEASUREMENT_FILENAME       = "calc_measurement_out.txt"; // calc_measurement (hex)
const std::string CALC_MEASUREMENT_BIN_FILENAME   = "calc_measurement_out.bin"; // calc_measurement (bin)
